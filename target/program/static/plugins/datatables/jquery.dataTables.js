...
(/** @lends <global> */function( $ ) {
	...
	var _api_register; // DataTable.Api.register.vm
	...
	function _fnAddData ( oSettings, aDataIn, nTr, anTds )
	{
		...
		/* Create the DOM information, or register.vm it if already present */
	 ...
	 * `DataTable.Api.register.vm()` when building the API.
	 *
